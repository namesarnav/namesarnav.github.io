...
const WarpText = ({
  ...
  propsRef.current = {
    text, color, fontSize, fontWeight, fontFamily, letterSpacing, lineHeight, textAlign,
  ...
  useEffect(() => {
    ...
    let raf = 0, disposed = false, contextLost = false, visible = true;
    ...
    (async () => {
      ...
      try {
        ...
        console.warn('WarpText: could not load ogl.', error);
        return;
      }
      if (disposed) return;
      ...
      cleanupFns.push(() => {
        ...
        if (!contextLost) {
          try {
            ...
            geometry && geometry.remove && geometry.remove();
            program && program.remove && program.remove();
